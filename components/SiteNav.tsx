...
function NavDropdown({
  ...
  return (
    <div className="relative" onMouseEnter={onEnter} onMouseLeave={onLeave}>
      <button className="text-[13px] font-bold text-gray-800 hover:text-gray-900 transition-colors tracking-wide flex items-center gap-1">
        {label}
        <Chevron open={open} />
      </button>
      {open && (
    ...
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
      ...
      <div className="flex md:grid items-center h-[80px] px-4 sm:px-6 md:px-10 justify-between" style={{ gridTemplateColumns: '1fr auto 1fr' }}>
        ...
        <div className="hidden md:flex items-center gap-7">
          ...
          {/* Pricing — direct link */}
          <Link href="/#pricing" className="text-[13px] font-bold text-gray-800 hover:text-gray-900 transition-colors no-underline tracking-wide">PRICING</Link>
        </div>
