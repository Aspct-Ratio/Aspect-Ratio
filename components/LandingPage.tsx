...
function MockupCropDemo() {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      ...
      // drag text down
      else if (e < 14000)     { cx = lerp(50, 49, ep(e, 11500, 14000)); cy = lerp(40, 55, ep(e, 11500, 14000)) }
      ...
      let textX = 49, textY = 35
      const textDragging = e >= 11500 && e < 14000
      if (e >= 11500 && e < 14000) {
        textX = lerp(49, 49, ep(e, 11500, 14000))
    ...
    <div className="flex flex-col items-center px-4 py-4">
      <div className="relative rounded-lg overflow-hidden" style={{ width: 270, height: 480 }}>
        ...
        <img
          ...
          style={{ transform: `scale(${zoom / 100}) translate(${panX}%, ${panY}%)`, transformOrigin: '65% 80%' }}
        />
        {/* Text overlay */}
    ...
    <div className="bg-white text-gray-800 antialiased leading-relaxed">
      ...
      <nav aria-label="Main navigation" className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
        ...
        <div className="flex md:grid items-center h-[80px] px-4 sm:px-6 md:px-10 justify-between" style={{ gridTemplateColumns: '1fr auto 1fr' }}>
          ...
          <div className="hidden md:flex items-center gap-7">
            ...
            {/* Pricing — direct link */}
            <a href="#pricing" className="text-[13px] font-extrabold text-gray-900 hover:text-indigo-600 transition-colors no-underline tracking-wide">PRICING</a>
          </div>
      ...
      <section className="pt-24 pb-20 px-6 text-center bg-gradient-to-b from-white to-gray-50">
        ...
        <p className="text-[18px] text-gray-500 max-w-[560px] mx-auto mb-11 leading-[1.7] font-normal">
          Generate campaign-ready assets for social, ecommerce, paid media and retail—automatically cropped, named and organized in minutes.
        </p>
      ...
      <div className="border-t border-b border-gray-100 bg-white py-6 px-6">
        <div className="max-w-[900px] mx-auto flex items-center justify-center">
          <span className="text-xs font-semibold text-gray-400 uppercase tracking-[0.8px]">Brands&emsp;·&emsp;Agencies&emsp;·&emsp;Studios&emsp;·&emsp;Creatives</span>
        </div>
      </div>
