  ...
  return (
    <div className="animate-fade-up">
      ...
      <div className="flex justify-between items-center mt-9 pt-5 border-t border-gray-200">
        ...
        <button onClick={onNext} className="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg transition">Next: Add Copy →</button>
      </div>
    </div>
  )
}
